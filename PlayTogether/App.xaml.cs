using PlayTogether.AppSettings;
...
namespace PlayTogether
{
    ...
    public sealed partial class App : Application
    {
        ...
        public static Classes.HigtScore.HigtScore hS { get; set; }
        public static SettingsGame settingsGame { get; set; }
        /// <summary>
        ...
        public App()
        {
            ...
            settingsGame = new SettingsGame();
            game = new Game();
            hS = new Classes.HigtScore.HigtScore();
            hS.load();
            settingsGame.load();
        }
